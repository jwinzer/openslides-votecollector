...
angular.module('OpenSlidesApp.agenda.site', [
    ...
    'OpenSlidesApp.openslides_votecollector'  // FIXME JW
])
...
.controller('ItemDetailCtrl', [
    ...
    'SpeakerList',
    'item',
    function ($scope, $filter, $http, $state, operator, Agenda, User, SpeakerList, item) {
        ...
        SpeakerList.setup(item.id, $scope);  // FIXME JW
